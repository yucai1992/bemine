# "Will You Be My Girlfriend?" Interactive Page

A fun, interactive "Will you be my Girlfriend?" page where the "Yes" button grows bigger every time they click "No" — with falling hearts, cute GIFs, music, and playful toast messages. Built with pure HTML, CSS, and JavaScript.
...
- Tell it exactly what you're imagining. Some ideas:
  ...
  - A countdown with daily messages
...
```
v-day/
├── index.html       # Main page — "Will you be my Girlfriend?"
